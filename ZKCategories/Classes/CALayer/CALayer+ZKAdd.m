...
- (UIViewContentMode)contentMode {
    return ZKCAGravityToUIViewContentMode(self.contentsGravity);
}

- (void)setContentMode:(UIViewContentMode)contentMode {
    self.contentsGravity = ZKUIViewContentModeToCAGravity(contentMode);
}
...
- (void)addFadeAnimationWithDuration:(NSTimeInterval)duration curve:(UIViewAnimationCurve)curve {
    ...
    [self addAnimation:transition forKey:@"zkcategories.fade"];
}

- (void)removePreviousFadeAnimation {
    [self removeAnimationForKey:@"zkcategories.fade"];
}
